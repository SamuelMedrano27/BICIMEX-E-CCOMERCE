...
class Venta
{
  ...
  function verificarCondicion($idVenta)
  {
    $sql = "SELECT condicion FROM venta WHERE idventa='$idVenta'";
    return ejecutarConsultaSimpleFila($sql);
  }
  ...
  public function getUserList($idUsuario)
  {
    $sql = "SELECT * FROM venta WHERE idusuario='$idUsuario'";
    return ejecutarConsulta($sql);
  }

  public function getIdUsuario($idVenta)
  {
    $sql = "SELECT idusuario FROM venta WHERE idventa='$idVenta'";
    return ejecutarConsultaSimpleFila($sql);
  }
